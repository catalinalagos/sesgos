...
const DATABASE_COLLECTION = "Sesgos";
  ...
  try {
    await client.connect();
        ...
        if (counternc>counterc){
          return res.sendFile(__dirname+'/public/questions.html');
        }
        else{
          return res.sendFile(__dirname+'/public/questions_nc.html');
        }
...
app.post("/formPost", async (req, res) => {
    try {
      var contentsub=req.body.content;
        ...
        const doc = { type: req.body.type, pais: req.body.pais, texto: req.body.texto, sesgo: req.body.sesgos };
